...
export const COSTUMES: Costume[] = [
  // בנים
  {
    id: 'mordechai',
    name: 'מרדכי היהודי',
    description: 'תחפושת מרדכי היהודי עם גלימה מלכותית',
    gender: 'boy',
    prompt: 'A boy img as a noble Jewish man wearing a royal blue and gold robe with silver embroidery, long white beard, dignified pose in palace courtyard, traditional Jewish clothing from ancient Persia, modest dress, cinematic lighting, high quality portrait'
  },
  {
    id: 'moshe',
    name: 'משה רבנו',
    description: 'תחפושת משה רבנו עם גלימה לבנה',
    gender: 'boy',
  ...
  // בנות
  {
    id: 'esther',
    name: 'מלכת אסתר',
    description: 'תחפושת מלכת אסתר עם שמלה מלכותית צנועה',
    gender: 'girl',
